...
pub struct RequesterConfig {
    ...
    /// Address the aggregation gRPC server listens on, from `GRPC_ADDRESS`. Only honoured by
    /// builds with the `agglayer` feature; when unset the proposer drives aggregation itself.
