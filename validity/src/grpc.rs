...
//! server is enabled the coordinator does that instead: it picks the range, asks for the
//! aggregation proof here, and relays the result on-chain itself. Range proof production is
